/**
 *    Filename: CarbonationPanel.java
 *     Version: 0.9.0
 * Description: Carbonation Panel
 *     License: GPLv2
 *        Date: 2017-01-14
 *
 * @author unknown
...
import com.homebrewware.PrimeSugar;
...
public class CarbonationPanel extends javax.swing.JPanel implements ActionListener, FocusListener {
    ...
    public void displayCarb(){
        ...
        textBottleTemp.setText(StringUtils.format(myRecipe.getBottleTemp(), 1));
        textServTemp.setText(StringUtils.format(myRecipe.getServTemp(), 1));
        textTargetVol.setText(StringUtils.format(myRecipe.getTargetVol(), 1));
        ...
        textDissolvedVol.setText(StringUtils.format(dissolvedCO2, 1));
        textPrimeAmount.setText(StringUtils.format(myRecipe.getPrimeSugarAmt(), 2));
        lPrimeU.setText(myRecipe.getPrimeSugarU());

        // Force carb
        textKegPresure.setText(StringUtils.format(myRecipe.getKegPSI(), 1));
        lPrimeU.setText(myRecipe.getPrimeSugarU());
        checkKegged.setSelected(myRecipe.isKegged());

        textHeight.setText(StringUtils.format(myRecipe.getKegTubeHeight(), 1));
        comboTubingID.setSelectedItem(myRecipe.getKegTubeID());
        textTubingFeet.setText(StringUtils.format(myRecipe.getKegTubeLength(), 1));
        textTubingVol.setText(StringUtils.format(myRecipe.getKegTubeVol(), 1));
        dontUpdate = false;
    }
