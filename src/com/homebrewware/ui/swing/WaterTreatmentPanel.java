/**
 *    Filename: WaterTreatmentPanel.java
 *     Version: 0.9.0
 * Description: Water Treatment Panel
 *     License: GPLv2
 *        Date: 2017-01-14
 *
 * @author unknown
...
public class WaterTreatmentPanel extends javax.swing.JPanel implements ActionListener, FocusListener, KeyListener {
    ...
    public void displayWaterTreatment() {
        ...
        textCaS.setText(StringUtils.format(source.getCa(), 1));
        textClS.setText(StringUtils.format(source.getCl(), 1));
        textMgS.setText(StringUtils.format(source.getMg(), 1));
        textNaS.setText(StringUtils.format(source.getNa(), 1));
        textSo4S.setText(StringUtils.format(source.getSo4(), 1));
        textCarbonateS.setText(StringUtils.format(source.getHco3(), 1));
        textHardnessS.setText(StringUtils.format(source.getHardness(), 1));
        textAlkS.setText(StringUtils.format(source.getAlkalinity(), 1));
        textTDSS.setText(StringUtils.format(source.getTds(), 1));
        textMashPHS.setText(StringUtils.format(source.getPh(), 1));

        textCaT.setText(StringUtils.format(target.getCa(), 1));
        textClT.setText(StringUtils.format(target.getCl(), 1));
        textMgT.setText(StringUtils.format(target.getMg(), 1));
        textNaT.setText(StringUtils.format(target.getNa(), 1));
        textSo4T.setText(StringUtils.format(target.getSo4(), 1));
        textCarbonateT.setText(StringUtils.format(target.getHco3(), 1));
        textHardnessT.setText(StringUtils.format(target.getHardness(), 1));
        textAlkT.setText(StringUtils.format(target.getAlkalinity(), 1));
        textTDST.setText(StringUtils.format(target.getTds(), 1));
        textMashPHT.setText(StringUtils.format(target.getPh(), 1));

        textCaD.setText(StringUtils.format(diff.getCa(), 1));
        textClD.setText(StringUtils.format(diff.getCl(), 1));
        textMgD.setText(StringUtils.format(diff.getMg(), 1));
        textNaD.setText(StringUtils.format(diff.getNa(), 1));
        textSo4D.setText(StringUtils.format(diff.getSo4(), 1));
        textCarbonateD.setText(StringUtils.format(diff.getHco3(), 1));
        textHardnessD.setText(StringUtils.format(diff.getHardness(), 1));
        textAlkD.setText(StringUtils.format(diff.getAlkalinity(), 1));
        textTDSD.setText(StringUtils.format(diff.getTds(), 1));
        textMashPHD.setText(StringUtils.format(diff.getPh(), 1));

        textCaR.setText(StringUtils.format(resultWater.getCa(), 1));
        textClR.setText(StringUtils.format(resultWater.getCl(), 1));
        textMgR.setText(StringUtils.format(resultWater.getMg(), 1));
        textNaR.setText(StringUtils.format(resultWater.getNa(), 1));
        textSo4R.setText(StringUtils.format(resultWater.getSo4(), 1));
        textCarbonateR.setText(StringUtils.format(resultWater.getHco3(), 1));
        textHardnessR.setText(StringUtils.format(resultWater.getHardness(), 1));
        textAlkR.setText(StringUtils.format(resultWater.getAlkalinity(), 1));
        textTDSR.setText(StringUtils.format(resultWater.getTds(), 1));
        textMashPHR.setText(StringUtils.format(resultWater.getPh(), 1));

        for (int i = 0; i < saltName.length; i++) {
            Salt s = myRecipe.getSaltByName(saltName[i]);
            if (myRecipe.getSaltByName(saltName[i]) != null) {
                textSaltsAmount[i].setText(StringUtils.format(s.getAmount(), 2));
                textSaltsVol[i].setText(StringUtils.format(s.getVol(), 2));
            } else {
        ...
        textSourcePH.setText(StringUtils.format(source.getPh(), 1));
        textSourceAlk.setText(StringUtils.format(source.getAlkalinity(), 1));
        textTargetPH.setText(StringUtils.format(target.getPh(), 1));
        ...
        textAcidAmount.setText(StringUtils.format(myRecipe.getAcidAmount(), 2));
        textAcidAmount5_2.setText(StringUtils.format(myRecipe.getAcidAmount5_2(), 2));
    }
