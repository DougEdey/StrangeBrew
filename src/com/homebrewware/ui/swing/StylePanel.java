...
public class StylePanel extends javax.swing.JPanel {
	...
	public void setStyleData(){
		...
		stlLowOG.setText(StringUtils.format(s.ogLow, 3));
		stlRcpOG.setText(StringUtils.format(myRecipe.getEstOg(), 3));
		stlHighOG.setText(StringUtils.format(s.ogHigh, 3));
		stlLowABV.setText(StringUtils.format(s.alcLow, 1));
		stlRcpABV.setText(StringUtils.format(myRecipe.getAlcohol(), 1));
		stlHighABV.setText(StringUtils.format(s.alcHigh, 1));
		stlLowColour.setText(StringUtils.format(s.srmLow, 1));
		stlRcpColour.setText(StringUtils.format(myRecipe.getColour(BrewCalcs.SRM), 1));
		stlHighColour.setText(StringUtils.format(s.srmHigh, 1));
		stlLowIBU.setText(StringUtils.format(s.ibuLow, 1));
		stlRcpIBU.setText(StringUtils.format(myRecipe.getIbu(), 1));
		stlHighIBU.setText(StringUtils.format(s.ibuHigh, 1));

		ogbuLbl.setText("" + StringUtils.format(myRecipe.getBUGU(), 1));
