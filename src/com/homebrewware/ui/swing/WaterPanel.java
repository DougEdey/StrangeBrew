...
public class WaterPanel extends javax.swing.JPanel implements ActionListener, FocusListener{
    ...
    public void displayWater(){
        ...
        totalWaterLbl.setText(StringUtils.format(myRecipe.getTotalWaterVol(myRecipe.getVolUnits()), 2));
        ...
        spargeWithLbl.setText(StringUtils.format(myRecipe.getSparge(), 1));
        spargeUnitsLbl.setText(mashUnitsAbrv);

        collectTxt.setValue(StringUtils.format(myRecipe.getPreBoilVol(myRecipe.getVolUnits()), 2));
        collectUnitsLbl.setText(recipeUnitsAbrv);
        postBoilTxt.setValue(StringUtils.format(myRecipe.getPostBoilVol(myRecipe.getVolUnits()), 2));
        postBoilUnitsLbl.setText(recipeUnitsAbrv);
        finalVolTxt.setValue(StringUtils.format(myRecipe.getFinalWortVol(myRecipe.getVolUnits()), 2));
        finalUnitsLbl.setText(recipeUnitsAbrv);


        chillShrinkLbl.setText(StringUtils.format(myRecipe.getChillShrinkVol(myRecipe.getVolUnits()), 2));
        kettleTxt.setValue(StringUtils.format(myRecipe.getKettleLoss(myRecipe.getVolUnits()), 2));
        kettleUnitsLbl.setText(recipeUnitsAbrv);
//      myRecipe.setTrubLoss(myRecipe.)
        trubLossTxt.setValue(StringUtils.format(myRecipe.getTrubLoss(myRecipe.getVolUnits()), 2));
        Debug.print("Trub loss units: " + myRecipe.getVolUnits());
        trubLossUnitsLbl.setText(recipeUnitsAbrv);
        miscLossTxt.setValue(StringUtils.format(myRecipe.getMiscLoss(myRecipe.getVolUnits()), 2));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (o == kettleTxt) {
            try {
                double x = StringUtils.round(myRecipe.getKettleLoss(myRecipe.getVolUnits()),2);
            ...
            try {
                double x = StringUtils.round(myRecipe.getMiscLoss(myRecipe.getVolUnits()),2);
            ...
            try {
                double x = StringUtils.round(myRecipe.getTrubLoss(myRecipe.getVolUnits()),2);
            ...
            try {
                double x = StringUtils.round(myRecipe.getPostBoilVol(myRecipe.getVolUnits()),2);
