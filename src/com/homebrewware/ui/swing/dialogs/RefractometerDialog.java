/**
 *    Filename: RefractometerDialog.java
 *     Version: 0.9.0
 * Description: Refractometer Dialog
 *     License: GPLv2
 *        Date: 2017-01-14
 *
 * @author uknown
...
public class RefractometerDialog extends javax.swing.JDialog implements ActionListener, FocusListener {
	...
	*/
	...
	private void displayCalcs() {
		...
		sgLbl.setText(StringUtils.format(sg, 3));
