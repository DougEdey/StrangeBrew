			...
			// this.setPreferredSize(new Dimension(400, 300));
			{
				...
				this.add(tablePanel);
				{
					...
					notesTableScroll.setPreferredSize(new java.awt.Dimension(235, 264));
					{
						...
						noteColumn.setCellEditor(new ComboBoxCellEditor(typeComboBox));
	...
	class NotesTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int row, int col) {
			...
			try {
				switch (col) {
					case 0 :
						return StringUtils.dateFormatShort.format(myRecipe.getNoteDate(row));
					case 1 :
		...
		public void setValueAt(Object value, int row, int col) {
			...
			try {
				switch (col) {
					case 0 :
						try {
							Date d = StringUtils.dateFormatShort.parse(value.toString());
...
//		JDialog dialog;
		...
		public Object getCellEditorValue() {
			return  StringUtils.dateFormatShort.format(datePicker.getDate());
		}
		...
		public Component getTableCellEditorComponent(JTable table, Object value,
			...
			try {
				datePicker.setDate(StringUtils.dateFormatShort.parse(value.toString()));
			} catch (Exception e) {
