...
public class SettingsPanel extends javax.swing.JPanel implements ActionListener, FocusListener {
    ...
    public void displaySettings(){
        ...
        mashoutTmpTxt.setText(StringUtils.format(myRecipe.mash.getTempRange(Mash.MASHOUT),2));
        spargeTmpTxt.setText(StringUtils.format(myRecipe.mash.getTempRange(Mash.SPARGE),2));
