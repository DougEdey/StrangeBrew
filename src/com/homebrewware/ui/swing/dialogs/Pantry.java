...
import com.homebrewware.ui.swing.FermentTableModel;
import com.homebrewware.ui.swing.PantryHopsTableModel;
import com.homebrewware.ui.swing.PantryFermTableModel;
import com.homebrewware.ui.swing.CellEditor;
import com.homebrewware.ui.swing.ComboBoxCellEditor;
import com.homebrewware.ui.swing.Table;
...
public class Pantry extends javax.swing.JDialog implements ActionListener, ChangeListener, FocusListener {
    ...
    Table pantryFermTable;
    Table pantryHopsTable;
    // Final GUI Elements
    ...
    private void layoutUi() {
        ...
        pnlTables.setLayout(pnlMaltsLayout);
        {
            ...
            pnlMalt.setLayout(pnlMaltLayout1);
            {
                pnlMalt.add(jScrollPane1, BorderLayout.CENTER);
                {
                    ...
                    pantryFermTable = new Table("maltTable") {
                        public String getToolTipText(MouseEvent e) {
                            java.awt.Point p = e.getPoint();
                            int rowIndex = rowAtPoint(p);
                            return StringUtils.multiLineToolTip(40, pantryFermTableModel
        ...
        pnlTables.add(pnlHops);
        {
            pnlHops.add(jScrollPane2, BorderLayout.CENTER);
            {
                ...
                pantryHopsTable = new Table("pantryHopsTable") {
                    public String getToolTipText(MouseEvent e) {
                        java.awt.Point p = e.getPoint();
                        int rowIndex = rowAtPoint(p);
                        return StringUtils.multiLineToolTip(40, pantryHopsTableModel
                                .getDescriptionAt(rowIndex));
