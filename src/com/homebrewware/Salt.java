...
//	public static final String CALCIUM_CHLORIDE = "Calcium Chloride";
	...
	public String toXML(int indent) {
		...
		xml += StringUtils.xmlElement("COMMONNAME", commonName, indent);
		xml += StringUtils.xmlElement("CHEM", chemicalName, indent);
		xml += StringUtils.xmlElement("AMOUNT", StringUtils.format(amount, 2), indent);
		xml += StringUtils.xmlElement("AMOUNTU", amountU, indent);
